// https://github.com/tanmayghosh2507/naive-bayes-20newsgroup-classification/
...
public class Model {
	...
	public HashMap<Integer, HashMap<Integer, Integer>> buildDocWordMapping(String file) throws IOException {
		...
		for (String str : lines) {
			...
			Double rCount = Double.parseDouble(line[2]);
			Integer toFeed = rCount.intValue();
			innerMap.put(Integer.parseInt(line[1]), toFeed);
